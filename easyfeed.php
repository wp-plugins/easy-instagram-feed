                                ...
                                <div id="setting_export_settings_file_text" class="format-settings">
                                    <div class="format-setting-wrap">
                                        <h3>Looking for Beta Testers</h3>
                                            <p>We are looking for the beta testers for the pro version of easy instagram feed. <br>In order to download the zip package of the pro version, Pls fill the Beta Tester Application Form <a href="http://webriti.com/easy-instagram-feed-beta-signup-form/" target="_blank">here</a>
                                            </p>
                                            
                                            <h3>Features Available in Premium Version.</h3>
                                            <ol>
                                                <li>Support for video type posts.</li>
                                                <li>Fetch feeds with the hash tags.</li>
                                                <li>Merge Posts from multiple ID's or hash tags into one feed.</li>
                                                <li>Load More button will get you infinite number of posts.</li>
                                                <li>More features will be added soon. If you have any feature in mind than do suggest us.</li>
                                            </ol>
                                          <p>  
                                             Love to hear from you , your suggestions are very valuable for us. We welcome your suggestions regading improovements, any specfic feature you want etc etc.
