                                ...
                                <div id="setting_export_settings_file_text" class="format-settings">
                                    <div class="format-setting-wrap">
                                        <h3>Looking for Beta Testers</h3>
                                            <p>We are looking for the beta testers for the pro version of easy instagram feed. In order to download the zip package of the pro version, Kindly subscribe <a href="http://webriti.com/easy-instagram-feed-beta-signup-form/" target="_blank">here</a>
                                            <br><br><br>
                                            
                                            Would love to hear from you , your suggestions are very valuable for us. We welcome your suggestions regading improovements, any specfic feature you want etc etc.
