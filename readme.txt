...
1. Download Custom Instagram Feed plugin.
...
After plugin activation  Go to "Custom Instagram feed" option panel, configure it and add the shortcode **[easyinstagramfeed]** in the WordPress Post / Pages.
...
User id and access token are mandatory. Note, you can use single access token for multiple user ids.
