...
Easy Instagram Feed plugin allows to display instagram photos on your WordPress site. Just add the shortcode *[easyinstagramfeed]* in the normal WordPress page/post inorder to get the feeds.
